...
<p>Приложение на Xamarin.Forms, должно помогать в расширении словарного запаса путём записи новых слов вручную. Можно записывать слова с переводом и транскрипцией, прослушать добавленное слово. Так же можно создавать коллекции слов, реализовано через отношение one-to-many, хотелось бы m-t-m, но отложил в долгий ящик. Всё это с сортировками по множеству критериев и поисками слов. 
<br/> Для более эфективного изучения есть мини-игра. Пока подбор слов для квиза идёт из общего списка слов, но в будущем хочу сделать выбор набора слов для повторения.</p>
